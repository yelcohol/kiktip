...
$share_href = '';
if ($member['mb_level'] >= $board['bo_write_level']) {
//		$share_href = "https://ssl.pstatic.net/static/common/spi/2020/0806/sp_spi_pc.png");
	$share_href = short_url_clean(G5_BBS_URL.'/board.php?bo_table='.$bo_table.'&amp;wr_id='.$wr_id);
}

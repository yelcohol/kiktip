...
<!--    여기부터 로그인 되지 않았을 경우-->
	    ...
	    <?php if ($is_email) { ?>
	    	<div class="form-group">
					<label for="wr_email" class="col-sm-2 control-label">E-mail</label>
					<span class="col-sm-7">
					<input type="email" name="wr_email" value="<?php echo $email ?>" id="wr_email" class="form-control email" maxlength="100">
					</span>
				</div>
	    <?php } ?>
...
<!--    여기까지 로그인 되지 않았을 경우-->
    ...
    <div class="bo_w_tit write_div">
        ...
        <div class="bo_w_link write_div">
            <label for="wr_1"><i class="fa fa-credit-card" aria-hidden="true"></i> <span class="sound_only">maker</span></label>
            <input type="text" name="wr_1" value="<?php echo $write['wr_1']?>" id="wr_1" class="frm_input full_input" placeholder="제품 가격이 있다면 입력해주세요.">
        </div>

        <!-- 배송비 - 0이면 무료배송 -->
        <div class="bo_w_link write_div">
            <label for="wr_1"><i class="fa fa-shopping-cart" aria-hidden="true"></i> <span class="sound_only">maker</span></label>
            <input type="text" name="wr_2" value="<?php echo $write['wr_2']?>" id="wr_2" class="frm_input full_input" placeholder="제품 배송비가 있다면 입력해주세요. (0 입력 무료배송)">
        </div>
    </div>

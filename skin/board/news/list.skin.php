            ...
            <td class="td_subject" style="padding-left:<?php echo $list[$i]['reply'] ? (strlen($list[$i]['wr_reply'])*10) : '0'; ?>px">
                <div class="mag_img">
                    <a href="<?php echo $list[$i]['href'] ?>" class="listImgA">
                        ...
                        <!-- <?php print_r($list[$i]);?> -->
                        <?php
                        $thumb = get_list_thumbnail('news', $list[$i]['wr_id'],200,200,false,true,'center', false,'80/0.5/3');
                        ?>
                        <i class="listImg">
                ...
                <div class="bo_tit">
                    ...
                    <div>
                        ...
                        <div class="mag_sub_sub"><?=$list[$i]['wr_1']?><span class="sound_only">부제</span></div>
                                                    
                    </div>
                    <div class="mag_info">
                    
                        <!-- 날짜 -->
                        <span class="mag_date"><?php echo date("Y년 m월 d일", strtotime($list[$i]['wr_datetime']));?></span>
                    </div>
                </div>
            </td>
            <!-- 글쓴이 -->

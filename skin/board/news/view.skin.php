...
<article id="bo_v" style="width:<?php echo $width; ?>">
    <header>
        ...
        <div class="profile_info">
            <span class="bo_v_cate"><?=$view['ca_name']?></span>
            <div class="profile_info_ct">
                <strong class="if_date"><span class="sound_only">작성일</span> <?php echo date("Y년 m월 d일", strtotime($view['wr_datetime'])) ?></strong>
            </div>
        </div>
            <span class="bo_v_tit">
            <?php
            ...
            ?></span>
            <div class="bo_v_sub"><?=$view['wr_1']?></div>
        </h2>
    </header>
...
;
    ...
    <section id="bo_v_atc">
        ...
        <div id="bo_v_share">
            <?php if ($share_href) { ?><button id="myInput" class="btn_copy" title="공유" onclick="copy_to_clipboard()">
                <i class="far fa-dot-circle" aria-hidden="true">주소 복사-<?php echo $view['href'] ?></i>
            </button><?php } ?>

	        <br>
            <?php include_once(G5_SNS_PATH."/view.sns.skin.php"); ?>
            <script src="//developers.kakao.com/sdk/js/kakao.min.js" charset="utf-8"></script>
            <script src="https://kiktip.com/js/kakaolink.js" charset="utf-8"></script>
        ...
        <div id="bo_v_act">
            ...
            <span class="bo_v_act_gng">
                <a href="<?php echo $good_href.'&amp;'.$qstr ?>" id="good_button" class="bo_v_good"><i class="fas fa-heartbeat" aria-hidden="true"></i><span class="sound_only">추천</span><strong><?php echo number_format($view['wr_good']) ?></strong></a>
        ...
        ?>
        <div id="bo_v_act">
            <?php if($board['bo_use_good']) { ?><span class="bo_v_good"><i class="fas fa-heartbeat" aria-hidden="true"></i><span class="sound_only">추천</span><strong><?php echo number_format($view['wr_good']) ?></strong></span><?php } ?>

...
<section id="bo_w">
    ...
    <div class="bo_w_tit write_div">
        ...
        <div class="bo_w_link write_div">
            <!-- <label for="wr_1"> <span class="sound_only">maker</span></label> -->
            <input type="text" name="wr_1" value="<?php echo $write['wr_1']?>" id="wr_1" class="frm_input full_input" placeholder="가급적 부제를 입력해주세요." style="padding-left:5px;">
        </div>
    </div>
